# ==============================================================================
# ORION UNIVERSAL COMMAND CORE v20.3 (BRUTE RE-SHIELD ARCHITECTURE) - FIXED
...
# FIX: REMOVED PYTHON F-STRING TO ELIMINATE NAMERROR ENTIRELY
# ==============================================================================
...
st.set_page_config(
    page_title="ORION COMMANDER v20.3",
    page_icon="🪐",
    layout="wide"
)
...
if "chat_history" not in st.session_state:
    st.session_state.chat_history = [
        {"role": "orion", "text": "Core v20.3 fehlerbereinigt, Commander! Der Klammer-Konflikt wurde neutralisiert. System bereit zum Testen."}
    ]
if "notes" not in st.session_state:
    st.session_state.notes = []
if "terminal_logs" not in st.session_state:
    st.session_state.terminal_logs = ["[SYS] Core v20.3 online. F-String-Bypass aktiv."]
...
with st.sidebar:
    ...
    st.markdown("<p style='color: #10b981; font-size: 11px; font-family: monospace;'>MASTER: Auth-x // VERSION 20.3</p>", unsafe_allow_html=True)
    st.divider()
...
# MAIN INTERFACE
st.markdown("<h1 style='color: #00d2ff; letter-spacing: 3px; margin-bottom: 0;'>ORION MAIN CORE v20.3</h1>", unsafe_allow_html=True)
st.divider()


# ==============================================================================
# DIE UNZERSTÖRBARE CORE-AUDIO-BRÜCKE (KEIN F-STRING MEHR = ABSOLUT SICHER!)
# ==============================================================================
is_funkraum = (module_selection == "🎙️ REINER FUNKRAUM (Audio Only)")

# Wir steuern die Höhe jetzt rein über Python, damit wir im HTML kein f-String brauchen
widget_height = 150 if is_funkraum else 0

# Reiner HTML-String ohne 'f' am Anfang. Jedes Zeichen wird exakt so an den Browser gesendet.
...
<script>
    ...
    if (!SpeechRecognition) {
        ...
        recognition.onresult = async (event) => {
            ...
            // HIER WAR DER FEHLER: Jetzt reines, natives JavaScript ohne Python-Interferenz!
...
# Das Widget wird unzerstörbar ganz oben ausgeführt
...
# SEKTOREN 3, 4, 5
    ...
    st.code("Core v20.3 online.", language="text")
